...
class dual_streamer(gr.top_block):
  def __init__(self, filenames, dev_addrs, onebit, iq, noise, mix, gain,
    fs, fc, unint, sync_pps):
...
if __name__ == '__main__':
  ...
  tb = dual_streamer(filenames=args.files, dev_addrs=args.addrs,
